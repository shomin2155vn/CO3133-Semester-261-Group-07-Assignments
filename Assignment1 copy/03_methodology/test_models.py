...
def test_all_architectures():
    ...
    models_dict = {
        "1. Linear / Softmax Classifier": LinearClassifier(in_features=784, num_classes=10),
        "2. Multilayer Perceptron (MLP)": MLP(in_features=784, hidden_dims=(256, 128), num_classes=10),
